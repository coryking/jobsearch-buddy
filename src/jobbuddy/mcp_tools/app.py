...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "Call `list_company_jobs(company, posted_since='1w')` per company "
        "and synthesize. Most boards answer in one round trip; heavily "
        "paginated ATSes (Workday) can take tens of seconds, so stagger "
        "those rather than fanning out everything at once.\n"
