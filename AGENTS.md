...
`.Codex/rules/` carries the rules the harness picks up automatically:
[`session-start.md`](.Codex/rules/session-start.md),
[`public-repo.md`](.Codex/rules/public-repo.md),
[`handoff-docs.md`](.Codex/rules/handoff-docs.md),
[`tdd-workflow.md`](.Codex/rules/tdd-workflow.md),
[`migrations.md`](.Codex/rules/migrations.md),
[`sync-pipeline.md`](.Codex/rules/sync-pipeline.md),
[`infrastructure.md`](.Codex/rules/infrastructure.md).
...
See `src/jobbuddy/AGENTS.md` for package-specific coding guidance.
